        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, models_1.Vendor.find({
                        ...
                        .populate("foods")];
            case 1:
                availableFoods = _a.sent();
                if (availableFoods.length === 0) {
                    return [2 /*return*/, res.status(400).json({ message: "No foods available" })];
                }
                return [2 /*return*/, res.status(200).json(availableFoods)];
        }
    });
}); };
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, models_1.Vendor.find({
                        ...
                        .limit(2)];
            case 1:
                topRestaurants = _a.sent();
                if (topRestaurants.length === 0) {
                    return [2 /*return*/, res.status(400).json({ message: "No restaurants available" })];
                }
                return [2 /*return*/, res.status(200).json(topRestaurants)];
        }
    });
}); };
...
var getFoodsIn30Min = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pincode, vendors, foodResult_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pincode = req.params.pincode;
...
var searchFoods = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var pincode, vendors, foodResult_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                pincode = req.params.pincode;
            ...
            case 1:
                ...
                if (vendors.length > 0) {
                    foodResult_2 = [];
                    vendors.map(function (vendor) { return foodResult_2.push.apply(foodResult_2, vendor.foods); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, models_1.Vendor.findById(restaurantId).populate("foods")];
            case 1:
                restaurant = _a.sent();
                if (!restaurant) {
