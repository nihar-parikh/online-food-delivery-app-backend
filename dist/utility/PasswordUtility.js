...
var generateToken = function (payload) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, jsonwebtoken_1.default.sign(payload, "".concat(process.env.JWT_SECRET), { expiresIn: "1d" })];
    });
}); };
exports.generateToken = generateToken;
var validateToken = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    var token, decodedUserData;
    return __generator(this, function (_a) {
        token = req.get("Authorization");
        if (token) {
            decodedUserData = jsonwebtoken_1.default.verify(token.split(" ")[1], "".concat(process.env.JWT_SECRET));
